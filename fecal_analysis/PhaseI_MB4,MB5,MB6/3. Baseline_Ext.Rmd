 ...
 for (b in samplelist_extcontrols){
  for (c in genus_list){
   ...
   if(control_type!="Water"){
    sample_name<-paste(control_type,a,sep="_")
    ...
    relabun_baseline_extcontrols[sample_name,"Ext.Kit"]<-as.character(metadata_baseline[b,"Ext.Kit"])
   }
  }
 }
}
...
write.csv(relabun_baseline_extcontrols,paste(project_location,"\\Output\\R\\Data\\Baseline\\relabun_baseline_extcontrols.csv",sep=""))
```
