 ...
 for (b in samplelist_baseline_seqcontrol){
  ...
  if(a==subject.id){
   ...
   for (c in genus_temp){
    ...
    relab_baseline_seqcontrols_expected[b,"Observed"]<-rel_abund_observed
    relab_baseline_seqcontrols_expected[b,"Expected"]<-rel_abund_expected
...
for (a in subjectlist_baseline_seqcontrol){
 for (b in samplelist_baseline_seqcontrol){
  ...
  if(a=subject.id){
   observed_count<-relab_baseline_seqcontrols_expected[b,"Observed"]+observed_count
   expected_count<-relab_baseline_seqcontrols_expected[b,"Expected"]
   gram_stain <- relab_baseline_seqcontrols_expected[b,"GramStain"]
   count = count+1
  }
 }
 relab_baseline_seqcontrols_expected[a,"Observed"]<-observed_count/count
 relab_baseline_seqcontrols_expected[a,"Expected"]<-expected_count
