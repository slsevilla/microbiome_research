...
for (a in samplelist_baseline_water){
 ...
 for (b in ncol(otu_baseline_filtered)-1){
   ...
   if(!(is.na(relab) | is.null(relab))){
     relab_baseline_blanks[a,b] <- otu_baseline_filtered[a,b]
   }
...
write.csv(relab_baseline_blanks,"/datatables/relab_baseline_blanks.csv")
...
```{r}
subjectlist_baseline_seqcontrol
...
for (a in subjectlist_baseline_seqcontrol){
 ...
 for (b in ncol(otu_baseline_filtered)-1){
   ...
   if(!(is.na(relab) | is.null(relab))){
     relab_baseline_seqcontrols[a,b] <- otu_baseline_filtered[a,b]
   }
...
write.csv(relab_baseline_blanks,"/datatables/relab_baseline_seqcontrols.csv")
