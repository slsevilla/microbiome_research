...
capture.output(s, file = paste(project_location,"\\Output\\R\\Data\\Baseline\\summary_prefilter.txt",sep=""))
```
...
capture.output(s, file = paste(project_location,"\\Output\\R\\Data\\Baseline\\summary_prefilter_sample.type.txt",sep=""))
s<-summary(sample_data(physeq_filt)$Sample.Cat)
capture.output(s, file = paste(project_location,"\\Output\\R\\Data\\Baseline\\summary_prefilter_sample.cat.txt",sep=""))
```
...
#Save file
file_name =paste(project_location,"\\Output\\R\\Graphs\\Baseline\\SeqDepth_prefilter.tiff",sep="")
...
#Save file
file_name =paste(project_location,"\\Output\\R\\Graphs\\Baseline\\SeqDepth_postfilter.tiff",sep="")
tiff(file_name, width=800)
print(p1)
dev.off()
...
p1<-ggplot(sample_sum_df, aes(x = sum, fill=Run.ID)) + 
  ...
  ggtitle("Distribution of Sample Sequencing Depth - Post-Filtering")
#Save file
file_name =paste(project_location,"\\Output\\R\\Graphs\\Baseline\\SeqDepth_postfilter_runid.tiff",sep="")
tiff(file_name, width=800)
print(p1)
dev.off()
...
capture.output(s, file = paste(project_location,"\\Output\\R\\Data\\Baseline\\summary_postfilter.txt",sep=""))

s<-summary(sample_data(physeq_filt)$Sample.Type)
capture.output(s, file = paste(project_location,"\\Output\\R\\Data\\Baseline\\summary_postfilter_sample.type.txt",sep=""))

s<-summary(sample_data(physeq_filt)$Sample.Cat)
capture.output(s, file = paste(project_location,"\\Output\\R\\Data\\Baseline\\summary_postfilter_sample.cat.txt",sep=""))
```
...
file_name =paste(project_location,"\\Output\\R\\Graphs\\Baseline\\alphadiv_sampletype.tiff",sep="")
tiff(file_name, width=800)
print(p)
dev.off()
...
file_name =paste(project_location,"\\Output\\R\\Graphs\\Baseline\\alphadiv_sequencingbatch.tiff",sep="")
tiff(file_name, width=800)
print(p)
dev.off()
```
...
for (a in phylos_obs){
 ...
 file_name =paste(project_location,"\\Output\\R\\OTUs\\otu_baseline_",count,".csv",sep="")
 write.csv(gentab,file_name)
 
 metatab <- as.data.frame(sample_data(a))
 file_name =paste(project_location,"\\Output\\R\\OTUs\\metadata_baseline_",count,".csv",sep="")
