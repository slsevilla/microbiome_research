...
OTU1 = as(otu_table(physeq_filt_seqcontrols), "matrix")
# transpose if necessary
if(taxa_are_rows(physeq_filt_seqcontrols)){OTU1 <- t(OTU1)}
# Coerce to data.frame
OTUdf = as.data.frame(OTU1)
write.csv(OTUdf,"/OTUs/otu_baseline_seqcontrols.csv")
...
# Coerce to data.frame
OTUdf = as.data.frame(OTU1)
write.csv(OTUdf,"/OTUs/otu_baseline_extcontrols.csv")
...
# Coerce to data.frame
OTUdf = as.data.frame(OTU1)
write.csv(OTUdf,"/OTUs/otu_baseline_study.csv")
