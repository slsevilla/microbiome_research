...
taxa_file=paste("taxa_Summary_",genus_level,"1.csv",sep="")
...
otu_baseline_complete <- read.table(paste(project_location,"\\Output\\R\\OTUs\\",taxa_file,sep=""),sep=",",header= TRUE)
