...
bar_percdiff<-function(df1,genus,dbs,controltype){
 ...
 ggplot(temp, aes(x = Source.Descrip, y = PercDiff)) +
     geom_bar(stat = "identity", position = "dodge") +
     labs(title=paste("Perecent Diff of ",genus,"- MSA Controls -", dbs,sep=""),
          x="Wall Type",
          y="Percent") +
     facet_wrap(~ Taxa) +
     theme_bw() +
...
setdiff(temp1,temp2) #should have no error

taxa_db_diffs<-taxa_diffs(temp1,temp2)
bar_percdiff(taxa_db_diffs,"Family","GreenGenes to Silva119","MSA")
bar_percdiff(taxa_db_diffs,"Family","GreenGenes to Silva119","Zymo")
