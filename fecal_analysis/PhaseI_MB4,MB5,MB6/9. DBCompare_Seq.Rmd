...
for (a in reference_db){
 ...
 for (b in taxa_levels){
  ...
  file_name =paste(output_location_seq,b,"\\Taxa\\taxa_",b,"_",a,".csv",sep="")
...
################## New Code
#Read in tax OTU tables
```{r}
for (a in reference_db){
 for (b in taxa_levels){
  tax_table_name<-paste("taxa",b,a,sep="_")
  assign(tax_table_name,read.csv(paste(output_location_seq,b,"\\Taxa\\taxa_",b,"_",a,".csv",sep="")))
 }
}
```
