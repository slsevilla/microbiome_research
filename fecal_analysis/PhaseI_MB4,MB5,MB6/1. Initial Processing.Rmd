...
#Create filtered phyloobject #blank samples
...
#Create filtered phyloobject #seq specific
...
#Create filtered phyloobject #ext specific
sub_types<-c("Ext.Control")
physeq_filt_sub <- subset_samples(physeq_filt, Source.Descrip %in% sub_types)
histo_filtering_graph(physeq_filt_sub, "Graphs\\SeqDepth_prefilter_blanks.tiff")
```
...
rare_curves(physeq_filt_prune,"Run.ID","","Rarecurve_pre-downsamp")
rare_curves(physeq_filt_prune,"Run.ID","Sample.Type","Rarecurve_pre-downsamp_sampletype")

#After scaling
physeq_scale<-downsample_reads(physeq_filt_prune)
rare_curves(physeq_scale,"Run.ID","","Rarecurve_post-downsamp")
rare_curves(physeq_scale,"Run.ID","Sample.Type","Rarecurve_post-downsamp_sampletype")

#Subset
subset_list<-c("Ext.Control") 
physeq_scale_sub<-subset_samples(physeq_scale, Sample.Type %in% subset_list)
rare_curves(physeq_scale_sub,"Run.ID","","Rarecurve_PostFiltering_ExtC")

subset_list<-c("Seq.Control") 
physeq_scale_sub<-subset_samples(physeq_scale, Sample.Type %in% subset_list)
rare_curves(physeq_scale_sub,"Run.ID","Sample.Type","Rarecurve_PostFiltering_SeqC")
rare_curves(physeq_scale_sub,"Run.ID","Source.Descrip","Rarecurve_PostFiltering_SeqC_SDesc")
