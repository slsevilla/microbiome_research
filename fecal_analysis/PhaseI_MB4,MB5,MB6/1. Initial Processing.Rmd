...
plot_beta<-function(phyobj,type,dist_meas,colby){
 ...
 allGroupsColors<- c("grey50")
 allGroupsColors<-append(allGroupsColors,brewer.pal(n = 12, name = "Set1"))
 p1<-p1 + geom_point(size = 4) + scale_color_manual(values = allGroupsColors)
 p1
 
 tiff(paste(output_location,"\\Graphs\\betadiv_",type,".tiff",sep=""),compression="lzw")
 grid.draw(p1)
 dev.off()
