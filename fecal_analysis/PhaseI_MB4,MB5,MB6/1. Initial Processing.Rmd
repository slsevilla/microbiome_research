...
```{r}
split_phyloobject<-function(taxa_level,physeqobject,ref_db){
 ...
 file_name =paste(output_location,"Taxa\\taxa_",taxa_level,"_",ref_db,".csv",sep="")
 write.csv(taxtab,file_name)
  
 metatab <- as.data.frame(sample_data(physeqobject))
 file_name =paste(output_location,"Taxa\\metadata_Summary_",taxa_level,"_",ref_db,".csv",sep="")
...
for (a in taxa_levels){
 ...
 split_phyloobject(a,physeq_scale,reference_db)
}
